package by.it.group310951.porepko.lesson08;
...
public class B_Knapsack {
    ...
    int getMaxWeight(InputStream stream ) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            // массив, в котором хранится максимальный вес каждой вместимости
            int[] dp = new int[w + 1];

            // динамическое программирование
            for (int i = 0; i < n; i++) {

                // обновляем массив для всех возможных весов рюкзака
