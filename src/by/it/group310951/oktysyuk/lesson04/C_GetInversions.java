...
public class C_GetInversions {
    ...
    int calc(InputStream stream) throws FileNotFoundException {
        ...
        int[] temp = new int[n];
        // подсчет инверсий с помощью модификации сортировки слиянием
    ...
    // слияние двух отсортированных частей с подсчетом инверсий
    private int mergeAndCount(int[] array, int[] temp, int left, int mid, int right) {
        ...
        // копирование отсортированного массива в исходый
