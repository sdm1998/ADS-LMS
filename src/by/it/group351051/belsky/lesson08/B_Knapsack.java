package by.it.group351051.belsky.lesson08;
...
public class B_Knapsack {
    ...
    int getMaxWeight(InputStream stream ) {
        ...
        // Основной цикл для заполнения массива dp
        for (int i = 0; i < n; i++) {
            // Идем в обратном порядке, чтобы не использовать один и тот же слиток несколько раз
