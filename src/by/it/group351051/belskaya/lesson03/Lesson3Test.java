...
public class Lesson3Test {
    ...
    */
    ...
    public void A() throws Exception {
        ...
        File f = new File(root + "by/it/group351051/belskaya/lesson03/dataHuffman.txt");
    ...
    public void C() throws Exception {
        String root = System.getProperty("user.dir") + "/";
        InputStream stream = new FileInputStream(root + "by/it/group351051/belskaya/lesson03/heapData.txt");
